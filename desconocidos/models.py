...
class Desconocido(models.Model):
    ...
    num_pol = models.CharField(max_length=4, blank=True, null=True)
    letra_pol = models.CharField(max_length=1, blank=True, null=True)
    num_pol_2 = models.CharField(max_length=4, blank=True, null=True)
    letra_pol_2 = models.CharField(max_length=1, blank=True, null=True)
    escalera = models.CharField(max_length=2, blank=True, null=True)
    planta = models.CharField(max_length=3, blank=True, null=True)
    puerta = models.CharField(max_length=5, blank=True, null=True)
    dir_no_estruc = models.CharField(max_length=25, blank=True, null=True)
